...
module.exports = class CommandHandler {
  constructor (client) {
    // The client, aka bot object, different from Discord.client()
    this.client = client;
    this.commands = new Discord.Collection();
    this.cooldowns = new Discord.Collection();    

    try {
      // Interaction object used for handling Discord Slash Commands
      this.slashCommands = new DiscordInteractions({
  ...
  async loadCommands () {
    ...
    try {      
      let result = await readdir(commandsDir);
